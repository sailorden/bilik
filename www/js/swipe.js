(function(ionic) {
  ...
  var SwipeableCardController = ionic.views.View.inherit({
    initialize: function(opts) {
      ...
      this.cardPopInDuration = opts.cardPopInDuration || 1000;
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    transitionOut: function() {
      ...
      if(this.y < 50) {
        ...
        var duration = 0.3; // this.rotationAngle ? 0.2 : 0.5;
    ...
    _doDrag: function(e) {
      ...
      //edited
      var otherCards = document.getElementsByClassName("cardSwiping");
      if(otherCards[otherCards.length-1] && parseInt(this.y) > 6){
        var red = this.rotationAngle > 0 ? 225 + parseInt(this.y) : 225 - parseInt(this.y);
        var green = this.rotationAngle > 0 ? 225 - parseInt(this.y) : 225 + parseInt(this.y);
        otherCards[otherCards.length-1].style.background = "rgb("+red+", "+green+ ", "+ (225 - parseInt(this.y))+")";
        
      }else{
         otherCards[otherCards.length-1].style.background = "rgb(225, 225, 225)";
      }
      //edited
